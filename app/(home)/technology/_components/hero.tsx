...
const Hero = () => {
    return (
        <div className="min-h-[45vh] md:min-h-[70vh] h-fit max-w-screen relative overflow-hidden">
            ...
            <div className='max-w-7xl mx-auto flex items-center text-white h-full mt-20 md:mt-40 justify-center md:justify-end relative z-10 px-4'>
                <div className="max-w-3xl text-center md:text-right">
                    <h1 className="adumu text-5xl md:text-6xl lg:text-7xl leading-tight md:leading-[6rem]">changing <br /> viewpoint</h1>
