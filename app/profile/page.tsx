...
const App = () => {
  ...
  const player = user
    ? {
        ...
        positions:
          user.selectedPositions || (user.position ? [user.position] : []),
  ...
  return (
    <div className="flex flex-col min-h-fit bg-white montserrat">
      {/* Main Content */}
      <main className="flex-1 container mx-auto px-2 sm:px-4 py-8 sm:py-32 w-full">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
          {/* Left Column - Profile Picture */}
          <div className="md:col-span-3 mb-6 md:mb-0 flex justify-center items-start">
          ...
          <div className="md:col-span-5 mb-6 md:mb-0">
            ...
            <div className="gap-3 grid grid-cols-2 sm:gap-6 mb-6 sm:mb-8">
              <ActionButton
                icon={<LockIcon size={20} className="sm:w-6 sm:h-6" />}
...
const ActionButton = ({
  ...
  <button
    className="w-full border border-gray-200 flex flex-col items-center justify-center space-y-1 sm:space-y-2 py-2 sm:py-4 shadow-sm rounded-lg hover:bg-gray-50 transition-all"
    onClick={onClick}
  >
  ...
  return (
    <div className="mt-2 sm:mt-4">
      <div className="flex justify-between text-xs sm:text-sm mb-1 font-medium">
        <span className="text-gray-500 font-[400] text-[10px] sm:text-xs ">
          {label}
        </span>
